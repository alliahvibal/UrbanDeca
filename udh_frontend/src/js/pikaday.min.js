!(function (e, t) {
  ...
  var t = "function" == typeof e,
    ...
    l = function (e, t) {
      h(e, t) || (e.className = "" === e.className ? t : e.className + " " + t);
    },
    d = function (e, t) {
    ...
    v = function (e, t, n) {
      var i;
      a.createEvent
        ? ((i = a.createEvent("HTMLEvents")).initEvent(t, !0, !1),
          (i = D(i, n)),
          e.dispatchEvent(i))
        : a.createEventObject &&
    ...
    k = function (e, t, n) {
      ...
      return (
        '<td class="pika-week">' +
        Math.ceil(((new Date(n, t, e) - a) / 864e5 + a.getDay() + 1) / 7) +
        "</td>"
      );
    },
    x = function (e, t, n, a) {
    ...
    N = function (e) {
      ...
      return (
        "<thead><tr>" + (e.isRTL ? n.reverse() : n).join("") + "</tr></thead>"
      );
    },
    S = function (e, t, n, a, i, s) {
      ...
      for (
        l =
          ...
          "</select></div>",
          u(c.yearRange)
            ? ((o = c.yearRange[0]), (r = c.yearRange[1] + 1))
            : ((o = n - c.yearRange), (r = 1 + n + c.yearRange)),
          h = [];
        o < r && o <= c.maxYear;
        o++
      )
      ...
      return (
        (d =
          ...
          h.join("") +
          "</select></div>"),
        c.showMonthAfterYear ? (m += d + l) : (m += l + d),
    ...
    I = function (o) {
      ...
      (r._onMouseDown = function (e) {
          ...
          if (t)
            if (
              (h(t, "is-disabled") ||
                (!h(t, "pika-button") ||
                h(t, "is-empty") ||
                h(t.parentNode, "is-disabled")
                  ? h(t, "pika-prev")
                    ? r.prevMonth()
                    : h(t, "pika-next") && r.nextMonth()
                  : (r.setDate(
                      new Date(
                    ...
                    l.bound &&
                      i(function () {
                        r.hide(),
                          l.blurFieldOnSelect && l.field && l.field.blur();
                      }, 100))),
              h(t, "pika-select"))
            )
              r._c = !0;
        ...
        (r._onChange = function (e) {
          var t = (e = e || window.event).target || e.srcElement;
          t &&
            (h(t, "pika-select-month")
              ? r.gotoMonth(t.value)
              : h(t, "pika-select-year") && r.gotoYear(t.value));
        }),
        (r._onKeyChange = function (e) {
          if (((e = e || window.event), r.isVisible()))
            switch (e.keyCode) {
              case 13:
              case 27:
        ...
        (r._onInputChange = function (n) {
          ...
          n.firedBy !== r &&
            ((a = l.parse
              ? l.parse(l.field.value, l.format)
              : t
              ? (a = e(l.field.value, l.format, l.formatStrict)) && a.isValid()
                ? a.toDate()
                : null
        ...
        s(a, "keydown", r._onKeyChange),
        l.field &&
          (l.container
            ? l.container.appendChild(r.el)
            : l.bound
            ? a.body.appendChild(r.el)
            : l.field.parentNode.insertBefore(r.el, l.field.nextSibling),
          s(l.field, "change", r._onInputChange),
          l.defaultDate ||
            (t && l.field.value
      ...
      c(d)
        ...
        l.bound
          ? (this.hide(),
            ...
            s(l.trigger, "click", r._onInputClick),
            s(l.trigger, "focus", r._onInputFocus),
            s(l.trigger, "blur", r._onInputBlur))
          : this.show();
    };
  return (
    (I.prototype = {
      config: function (e) {
        ...
        if (
          ...
          (t.yearRange = Math.abs(parseInt(t.yearRange, 10)) || b.yearRange),
      ...
      setDate: function (e, t) {
        if (!e)
          return (
            ...
            this._o.field &&
              ((this._o.field.value = ""),
              v(this._o.field, "change", { firedBy: this })),
            this.draw()
          );
        if (("string" == typeof e && (e = new Date(Date.parse(e))), c(e))) {
          var n = this._o.minDate,
            a = this._o.maxDate;
          c(n) && e < n ? (e = n) : c(a) && e > a && (e = a),
      ...
      adjustDate: function (e, t) {
        ...
        "add" === e
          ? (n = new Date(a.valueOf() + i))
          : "subtract" === e && (n = new Date(a.valueOf() - i)),
          this.setDate(n);
      },
      ...
      draw: function (e) {
        if (this._v || e) {
          var t,
            ...
            h = "";
          this._y <= a &&
            ((this._y = a), !isNaN(o) && this._m < o && (this._m = o)),
            this._y >= s &&
              ((this._y = s), !isNaN(r) && this._m > r && (this._m = r)),
            (t =
              "pika-title-" +
              Math.random()
                .toString(36)
          ...
          for (var l = 0; l < n.numberOfMonths; l++)
            h +=
              ...
              this.render(this.calendars[l].year, this.calendars[l].month, t) +
              "</div>";
          (this.el.innerHTML = h),
            n.bound &&
              "hidden" !== n.field.type &&
      ...
      adjustPosition: function () {
        ...
        if (!this._o.container) {
          if (
            ...
            (h = (d = e.getBoundingClientRect()).left + window.pageXOffset),
              (l = d.bottom + window.pageYOffset);
          else
            for (
              h = t.offsetLeft, l = t.offsetTop + t.offsetHeight;
              (t = t.offsetParent);

            )
              (h += t.offsetLeft), (l += t.offsetTop);
          ((this._o.reposition && h + n > s) ||
            (this._o.position.indexOf("right") > -1 &&
              h - n + e.offsetWidth > 0)) &&
            (h = h - n + e.offsetWidth),
            ((this._o.reposition && l + i > o + r) ||
              (this._o.position.indexOf("top") > -1 &&
                l - i - e.offsetHeight > 0)) &&
      ...
      render: function (e, t, n) {
        var a = this._o,
          ...
          r = [],
          h = [];
        p(i), a.firstDay > 0 && (o -= a.firstDay) < 0 && (o += 7);
        for (
          var l = 0 === t ? 11 : t - 1,
            d = 11 === t ? 0 : t + 1,
            u = 0 === t ? e - 1 : e,
          ...
          _ -= 7;
        v += 7 - _;
        for (var b = !1, w = 0, R = 0; w < v; w++) {
          var N = new Date(e, t, w - o + 1),
            S = !!c(this._d) && y(N, this._d),
            I = y(N, i),
            T = -1 !== a.events.indexOf(N.toDateString()),
            E = w < o || w >= s + o,
            Y = w - o + 1,
            O = t,
            j = e,
            W = a.startRange && y(a.startRange, N),
            A = a.endRange && y(a.endRange, N),
            F =
              a.startRange && a.endRange && a.startRange < N && N < a.endRange,
            L =
              (a.minDate && N < a.minDate) ||
              (a.maxDate && N > a.maxDate) ||
              (a.disableWeekends && f(N)) ||
              (a.disableDayFn && a.disableDayFn(N));
          E &&
            (w < o
              ? ((Y = D + Y), (O = l), (j = u))
              : ((Y -= s), (O = d), (j = g)));
          ...
          a.pickWholeWeek && S && (b = !0),
            h.push(M(P)),
            7 == ++R &&
              (a.showWeekNumber && h.unshift(k(w - o, t, e)),
              r.push(x(h, a.isRTL, a.pickWholeWeek, b)),
              (h = []),
              (R = 0),
              (b = !1));
        }
      ...
      show: function () {
        this.isVisible() ||
          ...
          d(this.el, "is-hidden"),
          this._o.bound &&
            (s(a, "click", this._onClick), this.adjustPosition()),
        ...
        if (isVisible) {
          var settings = $.extend(
            ...
            $.fn.countTo.defaults,
            {
              ...
              refreshInterval: $(element).data("refresh-interval"),
          ...
          var loopCount = 0,
            value = settings.from,
            data = $(element).data("countTo") || {};

          $(element).data("countTo", data);
...
(function ($) {
  $(window).scroll(function () {
    ...
    reveal(".slide-in-from-left");
    reveal(".slide-in-from-right");
    reveal(".dropdown-effect li");
    reveal(".fade-effect");
  });
