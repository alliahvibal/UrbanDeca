        ...
        <section className="portfolio-block block-intro">
          <div className="container">
            <div className="about-me">
              <p className="">
                Lorem <strong>Team Byron</strong> ipsum dolor sit amet,
                consectetur adipisicing elit. Doloribus cumque ipsum
                consequuntur!
              </p>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-md-12 col-lg-5">
              <img
                src={require("../assets/image/8990-logo.png")}
                height="250px"
                alt="8990_logo"
              />
            </div>
